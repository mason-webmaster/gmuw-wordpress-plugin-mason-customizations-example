...
/**
 * Main plugin file for the Mason WordPress customizations plugin for the instance: exampleinstance
 */

/**
 * Plugin Name:       Mason WordPress: Customizations Plugin: exampleinstance
 * Author:            Mason Web Administration
 * Plugin URI:        https://github.com/mason-webmaster/gmuw-wordpress-plugin-mason-customizations-exampleinstance
