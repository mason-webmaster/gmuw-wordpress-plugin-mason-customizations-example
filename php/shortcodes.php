...
add_action('init', function(){
    ...
    add_shortcode(
        'gmuw_exampleinstance_shortcode', //shortcode label (use as the shortcode on the site)
        'gmuw_exampleinstance_shortcode' //callback function
    );
...
function gmuw_exampleinstance_shortcode(){
